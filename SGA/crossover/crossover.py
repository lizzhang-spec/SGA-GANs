...
if __name__=="__main__":
    population=[[-0.029245996789307727, -0.956904216445325], [0.8912975396411065, -0.013086267581742916], [0.39247726816751793, -0.7811611499974365], [-0.08645403733924284, 0.19945257006490968]]
    pcross_real=1.0
    V=2
    minRealVal=(-1, -1)
    maxRealVal=(1, 1)
